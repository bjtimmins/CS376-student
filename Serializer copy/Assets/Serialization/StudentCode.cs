...
namespace Assets.Serialization
{
    ...
    {
        int currSerialNumber = 0;
        Dictionary<object, int> seen = new Dictionary<object, int>();
        /// <summary>
            ...
            WriteBracketedExpression(
                ...
                () =>
                {
                    ...
                    foreach (var field in fields)
                    {
                        ...
                        WriteField(fieldName, fieldValue, false);
                    }
                },
                "}"
            );
    ...
    {
        Dictionary<int, object> seen = new Dictionary<int, object>();
        /// <summary>
